...
public class UserBoard implements BoardInterface {
	...
	public UserBoard(User currentUser, Consumer<User> loggedInUserSetter, Runnable switcher) throws IOException {
		if (currentUser.getRole() != User.Role.USER) Platform.exit();
	...
	public void start(Stage stage) {
		...
		stage.setTitle(currentUser.getName() + " - Library Management");
