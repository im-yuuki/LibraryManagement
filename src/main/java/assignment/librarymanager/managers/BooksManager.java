...
import assignment.librarymanager.data.Book;
import assignment.librarymanager.data.BookDetails;
import assignment.librarymanager.data.BookDetailsBuilder;
...
public class BooksManager {
	...
	public BooksManager(Database database) {
